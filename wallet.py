...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210 YAH from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 YAH in block rewards plus fees, but
        ...
        # Send 100 YAH with subtract fee from amount
        ...
        # Sendmany 100 YAH with subtract fee from amount
