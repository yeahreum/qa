...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid yeahreum address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid yeahreum address" in e.error['message'])
